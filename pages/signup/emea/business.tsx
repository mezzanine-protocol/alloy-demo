...
import EmeaAccountHolderForm from '../../../components/emeaBusiness/EmeaAccountHolderForm';
import EmeaBusinessForm from '../../../components/emeaBusiness/EmeaBusinessForm';
...
import {
  ...
  SummaryField,
  Flex,
} from '../../../components/emeaBusiness/style';
    ...
    const entities = [
      {
        ...
        business_federal_ein: businessDataParsed.businessId,
        addresses: [
          {
            ...
            country_code: businessDataParsed.country,
          },
        ],
        representatives: [
          {
            ...
            addresses: [
              {
                ...
                country_code: primaryAccountDataParsed.country,
              },
            ],
          },
          ...(check
                  ...
                  addresses: [
                    {
                      ...
                      country_code: secondaryAccountDataParsed.country,
                    },
                  ],
                },
              ]
...
EmeaBusiness.getLayout = function getLayout(page: ReactElement) {
  return <FormLayout>{page}</FormLayout>;
};

export default EmeaBusiness;
